...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    MenuWidthSetting: typeof import('./../components/setting/components/menu-width-setting/index.vue')['default']
    ...
    OrderChart: typeof import('./../views/dashboard/components/chart/order-chart/index.vue')['default']
